...
def train():
    ...
    train_data = pd.read_csv('/Users/baeksujin/Desktop/lawchatbot/KBLawChat/project/Chatbot/lawdata.csv',encoding='utf-8')
    ...
    print(START_TOKEN + tokenizer.encode("아 배고파 짜장면 먹고싶다.") + END_TOKEN)
